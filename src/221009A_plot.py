...
df_221 = pd.read_csv(GRB221009A, header = None, names = col_names)
...
freq_13, freq_49, freq_85, freq_150, flux_total, luminosity = radio_bands(df_221)
...
spix_85_150 = spectral_index(df_221, lower_85, upper_150)    
...
spix_85_150 = spix_85_150[(spix_85_150['alpha'] != '23.006829') ]
#spix_85_150 = spix_85_150[(spix_85_150['alpha'] != -5.511545)]
