...
clean_GRB_data(freq_150, flux_col, flux_err_col, time_col)
...
#spix_49_85.to_csv('spectral data files/980329 spectra/980329_spectral_index(4.9-8.5).csv', index=True)
